...
//
// In your "lib/exsemantica_web/router.ex":
//
//     pipeline :browser do
//       ...
//       plug MyAuth
...
// inside a script tag in "lib/exsemantica_web/templates/layout/app.html.heex":
//
//     <script>window.userToken = "<%= assigns[:user_token] %>";</script>
//
// You will need to verify the user token in the "connect/3" function
// in "lib/exsemantica_web/channels/user_socket.ex":
//
...
let channel = socket.channel("exsem_feed:home", {})
channel.join()
...
channel.on("new_entry", (msg) => {
    console.log("New entry received", msg)
})

channel.on("update_trends", (msg) => {
