defmodule ExsemanticaWeb.Live.Socket do
  @moduledoc """
  A customized Phoenix.LiveView.Socket that can also handle the Exsemantica
  trends feed.

  This is typically mounted directly in the endpoint.
  ...
  channel "lv_semantic_feed:*", ExsemanticaWeb.Live.SemanticFeedChannel
